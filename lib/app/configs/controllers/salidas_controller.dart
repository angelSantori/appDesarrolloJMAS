...
class SalidasController {
  ...
  Future<bool> uploadDocumentoPago(String folio, Uint8List documento) async {
    try {
      final request = http.MultipartRequest(
        'POST',
        Uri.parse('${_authService.apiURL}/Salidas/UploadDocumentoPago/$folio'),
      );
  ...
  factory Salidas.fromMap(Map<String, dynamic> map) {
    return Salidas(
      ...
      salida_PresupuestoFolio: map['salida_PresupuestoFolio'] != null
          ...
          : null,
      salida_Estado: map['salida_Estado'] != null
          ? map['salida_Estado'] as bool
          : null,
      ...
      salida_Costo: map['salida_Costo'] != null
          ...
          : null,
      salida_Fecha: map['salida_Fecha'] != null
          ? map['salida_Fecha'] as String
          : null,
      ...
      salida_DocumentoFirma: map['salida_DocumentoFirma'] != null
          ...
          : null,
      salida_Pagado: map['salida_Pagado'] != null
          ? map['salida_Pagado'] as bool
          : null,
      ...
      idOrdenServicio: map['idOrdenServicio'] != null
          ? map['idOrdenServicio'] as int
          : null,
      idUserAutoriza: map['idUserAutoriza'] != null
          ? map['idUserAutoriza'] as int
          : null,
      idContratista: map['idContratista'] != null
          ? map['idContratista'] as int
          : null,
    );
  }
