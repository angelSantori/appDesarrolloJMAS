...
class OrdenCompra {
  ...
  factory OrdenCompra.fromMap(Map<String, dynamic> map) {
    return OrdenCompra(
      idOrdenCompra: map['idOrdenCompra'] != null
          ? map['idOrdenCompra'] as int
          : null,
      ...
      requisicionOC: map['requisicionOC'] != null
          ? map['requisicionOC'] as int
          : null,
      ...
      direccionEntregaOC: map['direccionEntregaOC'] != null
          ...
          : null,
      centroCostoOC: map['centroCostoOC'] != null
          ? map['centroCostoOC'] as String
          : null,
      centroBeneficioOC: map['centroBeneficioOC'] != null
          ? map['centroBeneficioOC'] as String
          : null,
      descripcionOC: map['descripcionOC'] != null
          ? map['descripcionOC'] as String
          : null,
      ...
      idProveedor: map['idProveedor'] != null
          ? map['idProveedor'] as int
          : null,
    );
  }
