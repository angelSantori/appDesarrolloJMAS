...
class Productos {
  ...
  factory Productos.fromMap(Map<String, dynamic> map) {
    return Productos(
      id_Producto: map['id_Producto'] != null
          ? map['id_Producto'] as int
          : null,
      ...
      prodCosto: map['prodCosto'] != null
          ...
          : null,
      prodUbFisica: map['prodUbFisica'] != null
          ? map['prodUbFisica'] as String
          : null,
      ...
      prodPrecio: map['prodPrecio'] != null
          ...
          : null,
      prodImgB64: map['prodImgB64'] != null
          ? map['prodImgB64'] as String
          : null,
      prodEstado: map['prodEstado'] != null
          ? map['prodEstado'] as String
          : null,
