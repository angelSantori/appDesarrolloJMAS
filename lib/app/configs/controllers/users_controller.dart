...
class Users {
  ...
  @override
  String toString() {
    return 'Users(id_User: $id_User, user_Name: $user_Name, user_Contacto: $user_Contacto, user_Access: $user_Access, user_Password: $user_Password, user_Rol: $user_Rol, idArea: $idArea, idRole: $idRole, role: $role)';
  }
