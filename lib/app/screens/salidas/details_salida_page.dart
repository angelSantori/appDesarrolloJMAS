...
import 'package:desarrollo_jmas/app/screens/salidas/widgets/details_producto_auxiliar.dart';
import 'package:desarrollo_jmas/app/screens/salidas/widgets/pdf_cancelacion.dart';
import 'package:desarrollo_jmas/app/screens/salidas/widgets/reimpresion_salida_pdf.dart';
...
import 'package:desarrollo_jmas/app/configs/controllers/cancelado_salida_controller.dart';
    ...
    try {
      ...
      if (productosParaPDF.isNotEmpty) {
        await generarPdfCancelacion(
          ...
          junta: widget.junta.juntaNombre ?? '',
