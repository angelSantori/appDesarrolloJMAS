...
class PdfSolicitudCompra {
  ...
  static Future<void> generarPdfSolicitudCompra({
    ...
    required DateTime? fechaValidacion, // Nuevo parámetro
    required DateTime? fechaAutorizacion, // Nuevo parámetro
  }) async {
    try {
      ...
      final pdfBytes = await _generatePdfSolicitudBytes(
        ...
        fechaValidacion: fechaValidacion, // Pasar nuevo parámetro
        fechaAutorizacion: fechaAutorizacion, // Pasar nuevo parámetro
      );
            ...
            children: [
              ...
              pw.Column(
                ...
                children: [
                  ...
                  pw.Table(
                    columnWidths: {
                      0: const pw.FixedColumnWidth(60), // Clave (más estrecha)
                      1: const pw.FlexColumnWidth(2), // Descripción
                      2: const pw.FixedColumnWidth(40), // Cantidad
                      3: const pw.FixedColumnWidth(55), // Costo
                    ...
                    children: [
                      ...
                      // Filas de productos MODIFICADAS
                      ...productos
                          .map((producto) => pw.TableRow(
                                children: [
                                  _buildDataCell(
                                      producto['clave']?.toString() ?? ''),
                                  _buildDataCell(producto['descripcion'] ?? ''),
                                  _buildDataCell(producto['cantidad']
                                          ?.toStringAsFixed(2) ??
                                      '0.00'),
                                  _buildDataCell(
                          ...
                          .toList(),
                      // Fila de total con celdas fusionadas MODIFICADA
                      pw.TableRow(
                        children: [
                          // Celda vacía para Clave
                          pw.Container(),
                          // Celda vacía para Descripción
                          pw.Expanded(
  ...
  // Los métodos auxiliares restantes permanecen igual...
