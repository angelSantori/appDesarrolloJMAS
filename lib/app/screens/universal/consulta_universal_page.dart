...
import 'package:desarrollo_jmas/app/configs/controllers/consulta_universal_controller.dart';
                      ...
                      Expanded(
                        child: CustomListaDesplegableTipo<Juntas>(
                          ...
                          onChanged: (j) => setState(() {
                            _selectedJuntaId = j?.idJunta;
                          }),
                          itemLabelBuilder: (j) =>
                              '${j.juntaNombre ?? 'Sin nombre'} (${j.idJunta})',
                          icon: Icons.people,
                        ),
                      ),
                      if (_selectedJuntaId != null)
