import 'package:desarrollo_jmas/app/screens/entradas/details_entrada_page.dart';
import 'package:desarrollo_jmas/app/screens/entradas/widgets/excel_entradas.dart';
          ...
          child: InkWell(
            onTap: () async {
              ...
              final junta = _junta.firstWhere(
                (jnt) => jnt.idJunta == entrada.id_Junta,
                orElse: () => Juntas(idJunta: 0, juntaNombre: 'Desconocido'),
              );
