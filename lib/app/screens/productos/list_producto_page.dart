import 'dart:convert';
import 'package:desarrollo_jmas/app/screens/productos/details_producto_page.dart';
import 'package:desarrollo_jmas/app/screens/productos/edit_producto_page.dart';
import 'package:desarrollo_jmas/app/screens/productos/widgets/excel_service.dart';
import 'package:desarrollo_jmas/app/screens/productos/widgets/listas_caracteristicas.dart';
...
class _ListProductoPageState extends State<ListProductoPage> {
  ...
  Future<void> _imprimirQRsPorRango() async {
          ...
          ElevatedButton(
            onPressed: isGenerating
                ...
                : () async {
                    ...
                    ); // Para permitir que la UI se actualice
    ...
    try {
      ...
      for (var producto in productosEnRango) {
        ...
        final cuentas = await ccController.listCCxProducto(
            ...
            onPressed: () async {
              ...
              try {
                ...
                if (productos.isEmpty) {
                  showAdvertence(
                    context,
                    'No se encontraron productos en ese rango',
                  );
                  return;
                }
  ...
  Future<Uint8List> _generateQrPdf(
    ...
    const qrSizeInInches = labelWidthInInches * 0.4;
    final qrPixelSize = (qrSizeInInches * 400)
        .toDouble(); // Para generar QR nítido
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: Icon(Icons.warning_rounded, color: Colors.green.shade800),
          ...
          IconButton(
            icon: Icon(Icons.qr_code_2, color: Colors.green.shade800),
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        double? invIniConteo = _allProductos
                            .firstWhere(
                              (captura) =>
                                  captura.id_Producto == producto.id_Producto,
                              orElse: () => Productos(prodExistencia: null),
                            )
                            .prodExistencia;
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Chip(
                                          label: Text(
                                            producto.prodEstado ?? 'Sin estado',
                                            style: const TextStyle(
                                              color: Colors.white,
                                              fontSize: 12,
                                              fontWeight: FontWeight.bold,
