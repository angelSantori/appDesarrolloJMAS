...
class ExcelEntradasRurales {
  static Future<void> generateExcelEntradasRurales({
    ...
    try {
      ...
      final juntasRurales =
          juntas.where((j) => !juntasEsp.contains(j.idJunta)).toList();
      ...
      for (var juntaId in entradasByJunta.keys) {
        final junta = juntasRurales.firstWhere((j) => j.idJunta == juntaId,
            orElse: () => Juntas());
        final totalCosto = totalCostoByJunta[juntaId] ?? 0;
        ...
        sheet
            ...
            .setText(junta.juntaCuentaCargo?.toString() ?? '0');
        ...
        sheet
            ...
            .setText('${junta.juntaNombre?.toUpperCase()}');
