    ...
    try {
      ...
      final salidasInPeriod = allSalidas.where((s) {
        if (s.salida_Fecha == null ||
            s.id_Junta != selectedJunta.idJunta ||
      ...
      final concepto =
          'SALIDAS DE ${selectedJunta.juntaNombre?.toUpperCase()} DEL 01 AL ${lastDay.day.toString().padLeft(2, '0')} DE ${getMonthName(selectedMonth).toUpperCase()} $currentYear';
      ...
      final String fileName =
          'Salidas_Almacen_${selectedJunta.juntaNombre}_${selectedMonth}_${DateTime.now().year}_${DateFormat('ddMMyyyy_HHmmss').format(DateTime.now())}.xlsx';
