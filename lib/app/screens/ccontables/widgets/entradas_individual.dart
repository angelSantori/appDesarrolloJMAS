    ...
    try {
      ...
      final entradasInPeriod = allEntradas.where((e) {
        if (e.entrada_Fecha == null ||
            e.id_Junta != selectedJunta.idJunta ||
      ...
      final concepto =
          'ENTRADAS DE ${selectedJunta.juntaNombre?.toUpperCase()} DEL 01 AL ${lastDay.day.toString().padLeft(2, '0')} DE ${getMonthName(selectedMonth).toUpperCase()} $currentYear';
      ...
      final String fileName =
          'Entradas_Almacen_${selectedJunta.juntaNombre}_${selectedMonth}_${DateTime.now().year}_${DateFormat('ddMMyyyy_HHmmss').format(DateTime.now())}.xlsx';
