...
Widget buildProductosAgregadosGeneral(
  ...
  Map<int, String>? cuentasContables,
}) {
  ...
  Map<int, TableColumnWidth> columnWidths = {
    ...
    1: FlexColumnWidth(2), // Descripción
  ...
  if (esPresupuesto) {
    ...
    columnWidths[4] = FlexColumnWidth(0.5); // Total
  }

  if (mostrarEliminar) {
    columnWidths[esPresupuesto ? 6 : 5] = FlexColumnWidth(0.3); // Eliminar
  }
      ...
      Table(
        ...
        children: [
          ...
          ...productosAgregados.asMap().entries.map((entry) {
            ...
            // Obtener la cuenta contable si está disponible
            String? ccProducto = cuentasContables != null
                ? cuentasContables[producto['id']]
                : null;
            ...
            return TableRow(
              ...
              children: [
                Column(
                  children: [
                    // Mostrar ccProducto si existe
                    if (ccProducto != null && ccProducto.isNotEmpty) ...[
                      Text(
                        ccProducto,
